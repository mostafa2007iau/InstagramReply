...
class InstaClient:
    ...
    def load_session(self):
        ...
        if os.path.exists(self.session_file):
            try:
                ...
                logger.warning(f"⚠️ Failed to load session: {ex}")
                try:
    ...
    def save_session(self):
        ...
        try:
            ...
            logger.warning(f"⚠️ Failed saving session: {ex}")
    ...
    def get_own_recent_media(self, limit: int = 20) -> List[Dict]:
        ...
        try:
            ...
            logger.error("⚠️ Failed to list medias: %s", ex)
        return medias
    ...
    def get_comments(self, media_pk: int, amount: int = 50) -> List[Dict]:
        ...
        try:
            ...
            logger.error("⚠️ Failed to fetch comments: %s", ex)
        return out
    ...
    def reply_comment(self, media_pk: int, comment_id: int, text: str) -> bool:
        ...
        try:
            ...
            logger.error("⚠️ Reply comment failed: %s", ex)
            return False
    ...
    def send_direct(self, username: str, text: str) -> bool:
        ...
        try:
            ...
            logger.error("⚠️ Send direct failed: %s", ex)
            return False
